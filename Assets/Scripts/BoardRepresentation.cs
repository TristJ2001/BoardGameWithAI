...
public class BoardRepresentation : IRepresentation
{
    ...
    public void SetPreviousPosition(int piece, Vector2Int prevPos)
    {
        if (piece == 1)
        {
            previousPlayerPiece1Pos = prevPos;
        }

        if (piece == 2)
        {
            previousPlayerPiece2Pos = prevPos;
        }

        if (piece == 4)
        {
            previousJumpPiece1Pos = prevPos;
        }
        
        if (piece == 5)
        {
            previousJumpPiece2Pos = prevPos;
        }
        
        if (piece == 6)
        {
            previousJumpPiece3Pos = prevPos;
        }
        
        if (piece == 7)
        {
            previousJumpPiece4Pos = prevPos;
        }
    }
    ...
    public BoardRepresentation(int[,] gameBoard){
    ...
    //Add empty and win tiles to gameBoard
    ...
    public IRepresentation Duplicate(){
        return new BoardRepresentation(gameBoard.Clone() as int[,]);
    }
        ...
        if (piece == 1 || piece == 2)
        {
                ...
                IsJumpPieceAtPos(xPos + 1, yPos))
            {
                ...
                else
                {
                    ...
                    // if (yPos - 1 > 0 && IsJumpPieceAtPos(xPos + 2, yPos - 1))
                    // {
                    //     if (yPos - 2 < 0
                    //         || IsJumpPieceAtPos(xPos + 2, yPos - 2)
                    //         || gameBoard[xPos + 2, yPos - 2] == 1
                    //         || gameBoard[xPos + 2, yPos - 2] == 2)
                    //     {
                    //         
                    //     }
                    //     else
                    //     {
                    //         Vector2Int position2 = new Vector2Int();
                    //
                    //         position2.x = xPos + 2;
                    //         position2.y = yPos - 2;
                    //
                    //         emptySpaces.Add(position2);
                    //     }
                    // }
                    
                    //Check if can jump again
                    // if (yPos + 1 < gameBoard.GetLength(1) && IsJumpPieceAtPos(xPos + 2, yPos + 1))
                    // {
                    ...
                    //     }
                    // }
                    // Debug.Log($"Empty Space: {position.x} ; {position.y}");
                }
            }
                ...
                IsJumpPieceAtPos(xPos, yPos + 1))
            {
                ...
                else
                {
                    ...
                    //Check if can jump again
                    // if (xPos - 1 > 0 && IsJumpPieceAtPos(xPos - 1, yPos + 2))
                    // {
                    //     if (xPos - 2 < 0
                    //         || IsJumpPieceAtPos(xPos - 2, yPos + 2)
                    //         || gameBoard[xPos - 2, yPos + 2] == 1
                    ...
                    //Check if can jump again
                    // if (xPos + 1 < gameBoard.GetLength(0) && IsJumpPieceAtPos(xPos + 1, yPos + 2))
                    // {
                    //     if (xPos + 2 >= gameBoard.GetLength(0)
                    //         || IsJumpPieceAtPos(xPos + 2, yPos + 2)
                    //         || gameBoard[xPos + 2, yPos + 2] == 1
    ...
    //Always move player 2 piece into win tile
    ...
    //Always move player 1 piece away from win tile if condition is met
    ...
    public override string ToString()
    {
        ...
        for (int j = YLength - 1; j >= 0; j--)
        {
            ...
            { 
                representation += GetPieceAtTile(i, j) + "\t";
            }
